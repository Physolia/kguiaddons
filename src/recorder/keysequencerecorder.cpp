...
QKeySequence KeySequenceRecorder::currentKeySequence() const
{
    ...
    return (d->m_isRecording && d->m_currentKeySequence.count() < KeySequenceRecorderPrivate::MaxKeyCount)
        ? appendToSequence(d->m_currentKeySequence, d->m_currentModifiers)
